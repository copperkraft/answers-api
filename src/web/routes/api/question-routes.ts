...
export function registerQuestionRoutes(app: Application, baseRoute: string) {
    ...
    app.post(baseRoute, userJwt, asyncHandlerWrap(questionController.create.bind(questionController)));
    app.get(baseRoute + '/:id', asyncHandlerWrap(questionController.getById.bind(questionController)));
